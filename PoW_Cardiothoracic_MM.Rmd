...
if(DatabaseConnection == TRUE){
  ...
  MM.Pres_Main %<>% dplyr::mutate(EuroScore_II = EuroScoreLog.II(MM.Pres_Main[c('EuroScore_age', 'EuroScore_sex', 'EuroScore_nyha', 'EuroScore_ri', 'EuroScore_eca', 'EuroScore_pm', 'EuroScore_pcs', 'EuroScore_cld', 'EuroScore_ae', 'EuroScore_cps', 'EuroScore_doi', 'EuroScore_nyha', 'EuroScore_ccs', 'EuroScore_lv_ef', 'EuroScore_rmi', 'EuroScore_ph', 'EuroScore_em', 'EuroScore_woi', 'EuroScore_sta'),]))
  
  ###need names to match the function names (maybe change the function)
...
#
MM.Pres_Main %<>% mutate(`PO_VENT_length_TEST` = PO_ExtbDt-PO_ICUAdmDt)
# MM.Pres_Main %<>% mutate(`PO_Vent>24hr` = if_else(`POST_OP_VENT_DURATION`>=24, 1, 0))

...
MM.Inf <-       dbGetQuery(con, statement = read_file('Query\\qry_MMPres_Inf.sql'))
MM.Pres_Main <- dbGetQuery(con, statement = read_file('Query\\qry_MMPres_Main.sql'))
MM.ReAdm <-     dbGetQuery(con, statement = read_file('Query\\qry_MMPres_ReAdm.sql'))
MM.RTT <-       dbGetQuery(con, statement = read_file('Query\\qry_MMPres_RTT.sql'))
...
```{r DataCleaning_CSV, eval=FALSE, message=FALSE, include=FALSE}
#Load Data -----------------------------

...
TimelineFunc <- function(x) {
  ...
  geom_vline(xintercept = weekenddates, alpha =0.2, size = 3.5) +
  ...
  geom_segment(aes(x = OpDate, xend = OpDate + 0.5, y = Pt_LName, yend = Pt_LName, 
  ...
  scale_linetype_manual(name = "", values = c(1, 1, 1, 1, 1, 1),
                        guide = guide_legend(override.aes = list(color = c("ICU Bed Block Duration" = "#D10202",
                                                                           "ICU Stay (Ready for Discharge)" = "#D16103",
                                                                           "Operation"= "#002953",
                                                                           "Total Stay" = "#000000",
                                                                           "Intubation" = "#0B6623",
                                                                           "IABP Duration" = "#95d4f3")))) +
...
IcuTimelineData[IcuTimelineData$Pt_LName == 'SHARMA, S', 'PO_IDCOutDate'] = as.Date('2019-01-24')

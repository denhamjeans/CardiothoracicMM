...
ggplot(IcuTimelineData, aes(y = Pt_LName)) +
  geom_segment(aes(x = AdmDate, xend = DischargeDate, y = Pt_LName, yend = Pt_LName, fill = "Admission Duration")) +
  geom_segment(aes(x = PO_ICUAdmDt, xend = PO_ICUOutDt, y = Pt_LName, yend = Pt_LName), size = 5, colour = "#D10202") +
  geom_segment(aes(x = PO_ICUAdmDt, xend = PO_RFWDt, y = Pt_LName, yend = Pt_LName), size = 5, colour = "#D16103") +
  geom_segment(aes(x = OpDate, xend = OpDate + 0.5, y = Pt_LName, yend = Pt_LName, colour = "Operation"), size = 5) +
  ...
  scale_colour_manual(values = c(Operation = "#4E84C4", "Admission Duration" = "#000000")) +
